...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  ghost:
    'bg-transparent text-text-primary hover:bg-accent-primary/10 focus-visible:ring-accent-primary border-accent-primary/50',
  danger:
    'bg-danger-primary text-text-primary hover:bg-danger-darker focus-visible:ring-danger-primary border-transparent',
};
